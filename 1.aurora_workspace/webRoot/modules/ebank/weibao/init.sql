begin
	...
	sys_service_pkg.sys_service_load('modules/ebank/weibao/batch_pay_send.svc','微保批量支付发送',0,1,0);
	sys_service_pkg.sys_service_load('modules/ebank/weibao/batch_pay_query.svc','微保批量支付查询',0,1,0);
