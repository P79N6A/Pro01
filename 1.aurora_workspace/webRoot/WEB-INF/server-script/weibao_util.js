...
function WeibaoUtil() {
	...
	this.sendUrl = String('http://' + this.host + ':' + this.port
			+ this.payContext);
	this.queryUrl = String('http://' + this.host + ':' + this.port
			+ this.queryContext);
};
...
WeibaoUtil.prototype.invokeInterface = function(sendStr, interfaceType,
	...
	try {
		...
		if (interfaceType == 'SEND') {
			formParams.add(new BasicNameValuePair('reqmsg', requestStr));
		} else if (interfaceType == 'QUERY') {
			formParams.add(new BasicNameValuePair('Version',
					postParam['Version']));
			formParams.add(new BasicNameValuePair('InputCharset',
					postParam['InputCharset']));
			formParams.add(new BasicNameValuePair('SignType',
					postParam['SignType']));
			formParams.add(new BasicNameValuePair('CustomerNo',
					postParam['CustomerNo']));
			formParams.add(new BasicNameValuePair('BatchOrderNo',
					postParam['BatchOrderNo']));
			formParams.add(new BasicNameValuePair('PayDate',
					postParam['PayDate']));
			formParams.add(new BasicNameValuePair('Sign', postParam['Sign']));
		}
