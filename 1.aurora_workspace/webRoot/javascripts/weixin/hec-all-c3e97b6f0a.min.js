...
hec.service("HecService", ['HecDefaults', function (hecDefaults) {
    var hostName = "http://hec.jklife.com";
    var resultLength = 10;
    var urls = {
        ...
        'todo_query_acp_requisition': hostName + '/' + 'autocrud/weixin.wfl.list.wfl_todo_query_acp_acp_requisition/query',
        'todo_query_work_order': hostName + '/' + 'autocrud/weixin.wfl.list.wfl_todo_query_gld_work_order/query',
        ...
        'done_query_acp_requisition': hostName + '/' + 'autocrud/weixin.wfl.list.wfl_done_query_acp_acp_requisition/query',
        'done_query_work_order': hostName + '/' + 'autocrud/weixin.wfl.list.wfl_done_query_gld_work_order/query',
        ...
        'detail_header_exp_report': hostName + '/' + 'autocrud/weixin.wfl.detail.wfl_detail_header_exp_report/query',
        'detail_header_exp_requisition': hostName + '/' + 'autocrud/weixin.wfl.detail.wfl_detail_header_exp_requisition/query',
        'detail_header_pay_requisition': hostName + '/' + 'autocrud/weixin.wfl.detail.wfl_detail_header_pay_requisition/query',
        'detail_header_acp_requisition': hostName + '/' + 'autocrud/weixin.wfl.detail.wfl_detail_header_acp_acp_requsition/query',
        'detail_header_work_order': hostName + '/' + 'autocrud/weixin.wfl.detail.wfl_detail_header_gld_work_order/query',
        ...
        'detail_lines_acp_requisition': hostName + '/' + 'autocrud/weixin.wfl.detail.wfl_detail_lines_acp_acp_requisition/query',
    ...
    return {
        ...
        getDetailLinesUrlTip: function (category) {
            switch (category) {
                ...
                case 'ACP_REQUISITION':
                    return 'detail_lines_acp_requisition';
            }
        },
        getDetailHeaderUrlTip: function (category) {
            switch (category) {
                ...
                case 'ACP_REQUISITION':
                    return 'detail_header_acp_requisition';
                case 'WORK_ORDER':
                    return 'detail_header_work_order';
            }
        },
        ...
        $scope.loadMoreUser = function () {
            ...
            userSelectS.queryEmployeeList({para: params}).then(function (resp) {
                if (resp.data) {
                    ...
                    //alert(JSON.stringify(resp.data));
                    $scope.config.users = $scope.config.users.concat(resp.data);
                }
...
hec.controller('WflDetailController', [
    ...
    function ($scope, $rootScope, $state, $stateParams, $ionicPopup, $ionicLoading, WflHandleService) {
        ...
        $scope.isAcpRequisition = function () {
            return $scope.config.workflowCategory == 'ACP_REQUISITION';
        };
        $scope.isWorkOrder = function () {
            return $scope.config.workflowCategory == 'WORK_ORDER';
        };
    ...
    function ($scope, $state, $stateParams, $ionicPopup, $ionicLoading, hecDefaults, hecS, wflDetailS, userInfoS) {
        ...
        $scope.goAttachmentList = function () {
            $state.go('wfl.detail.attachment', {
                ins_doc_category: $scope.datas.header.ins_doc_category,
                doc_id: $scope.datas.header.doc_id
            });
        }
        ...
        function __queryDetailInfo(headerId, workflowCategory) {
            if (!headerId)
                return;
            var headerPara = {doc_id: headerId},
                linePara = {doc_id: headerId, exp_rep_category: workflowCategory};
            //ptmplanPara = {doc_id: headerId};
...
hec.controller('WflDocAttachmentController', [
    ...
    function ($scope, HecService, wflDetailS, $stateParams, $ionicPopup) {
        ...
        //            //window.open(url + '?attachment_id=' + item.attachment_id, atmFrame);
        //        }
        //    });
        //}
        ...
        //function __init() {
        //    //$scope.config.isSafari = browser.versions.ios;
        //    var opt = {
        //        para: {
        //            ins_doc_category: $stateParams.ins_doc_category,
        //            doc_id: $stateParams.doc_id
        //        }
        //    }
        ...
        $scope.configSrc = {
            iframeSrc: 'modules/weixin/fnd/fnd_atm_view.screen?ins_doc_category=' + $scope.config.ins_doc_category + '&doc_id=' + $scope.config.doc_id
        }
    ...
    function ($scope, $rootScope, $state, tododonecategoryS) {
        ...
        $scope.config = {
            categories: [
                ...
                {
                    category_desc: '付款申请单',
                    category: 'ACP_REQUISITION',
                    suffix_url_name: 'query_acp_requisition',
                    img_src: 'images/weixin/list_category_11.png'
                },
                {
                    category_desc: '核算工单',
                    category: 'WORK_ORDER',
                    suffix_url_name: 'query_work_order',
                    img_src: 'images/weixin/list_category_09.png'
                }
            ],
            isTodo: false,
            viewTitle: '分类',
